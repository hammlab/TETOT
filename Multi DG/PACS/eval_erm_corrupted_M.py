...
from utils import load_PACS, eval_accuracy, mini_batch_class_balanced, eval_accuracy_disc_hinge, eval_entropy_disc
...
# Load Dataset
print("Loading data")
src_train_data, src_train_labels, src_test_data, src_test_labels, target_data, target_labels = load_PACS(SRCS, TRGS)
...
for corruption in imagenet_c_corruptions.CORRUPTIONS:
    ...
    for severity in range(1, 6):
        ...
        trg_entropy = eval_entropy_disc(encoded_target_images, trg_Y, classifier)
