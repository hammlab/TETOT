...
from utils import eval_accuracy, load_VLCS_sources, load_VLCS_targets
...
# Load Dataset
print("Loading data")
src_data_loaders, val_data, val_labels = load_VLCS_sources(SRCS, BATCH_SIZE)
...
optimizer_base_model = tf.keras.optimizers.SGD(1E-3)
optimizer_encoder = tf.keras.optimizers.SGD(1E-3)
optimizer_logits = tf.keras.optimizers.SGD(1E-3)
...
for epoch in range(EPOCHS):
    ...
    x, y = next(iter(src_data_loaders[0]))
